...
{{-- ฉันกำลังทำ Laravel นะ คือว่าณ ตอนนี้อะขอปรึกษาหน่อยสิ ว่า ฉันอะ มี user 14คน ต่อ 1 นะ คือ 1 user ต่อ 1 กบุ่มนะ แต่แอดมินอะ เป็น 0   แบ่งเป็น group เนาะ คือ1 user มี 1 กลุ่มนะ    1 - 14 เลย  แต่ 0 คือแอดมิน คือ ว่า ตาราง user อะ มีคอัมท username password group ซึ่ง id เป้น uudi ทีนี้ อะ  ฉันจำเปเนต้อเชคว้า user แต่ละuser 1หรือ พูดง่ายๆ ว่า  เป็นกลุ่มนั้นแหละ ซึ่ง การที่จะเข้าไปดูข้อมูล ของมคร แตละหน้านั้น   ต้องวามารถเข่้าได้เหนแค กลุ่ตัเอง เท่านั้น  ยกตัวย่าเช่น  กหลุ่มที่ 1 จะไปแดู๘องกลุ่ที่ 2 - 14 ไม่ได้ นึกออกไหมอะ --}}
